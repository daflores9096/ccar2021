        ...
        <tr>
            ...
            <td>
                <div class="btn-group" role="group" aria-label>
                    <a href="?controller=ventas&action=detalle&cod_fac=<?php echo $row->cod_fac; ?>" type="button" class="btn btn-primary" title="Ver detalle" style="background-color: steelblue"><i class="fas fa-eye"></i></a>&nbsp;&nbsp;
