...
<table class="table table-sm">
    ...
    foreach ($ventaList as $row){
        $precio_u = $row['precio_uni'] * 0.6;
        $importe_f = $row['importe_fac'] * 0.6;
        $total_f = $venta->total_fac * 0.6;
        ?>
        <tr>
            ...
            <td class="text-right"><?php echo $precio_u; ?></td>
            <td class="text-right"><?php echo $importe_f; ?></td>
        </tr>
        <?php
    }
    ?>
    ...
    <tr style="background-color: #E9ECEF">
        ...
        <td class="text-right"><strong><?php echo $total_f ?></strong></td>
    </tr>
    </tfoot>
</table>
